...
var GetAllUsers = function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                return [2 /*return*/, res.status.send(users)];
            case 2:
                e_1 = _a.sent();
...
var SaveUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, userName, user, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, user_1.default.create({ email: email, userName: userName })];
            case 2:
                user = _b.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, user_1.default.updateOne({ email: email }, { userName: userName })];
            case 4:
                _b.sent();
                return [2 /*return*/, res.status(201).send({ message: "success", user: user })];
            case 5: return [2 /*return*/, res.status(201).send({ message: "success", user: user })];
            case 6:
                e_2 = _b.sent();
                return [2 /*return*/, res.status(400).send({ message: "error" })];
