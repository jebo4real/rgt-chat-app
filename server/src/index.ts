...
const pubClient = createClient({ url: "redis://default:jqaLm0Yf6MDOutMCaLtnCBLFXAKvTCaC@redis-15424.c268.eu-west-1-2.ec2.cloud.redislabs.com:15424", legacyMode: true });
